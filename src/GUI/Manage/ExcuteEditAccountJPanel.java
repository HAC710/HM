 ...
 * @author dophu
 */
public class ExcuteEditAccountJPanel extends javax.swing.JPanel {

    /**
     * Creates new form ExcuteEditAccountJPanel
     */
    public ExcuteEditAccountJPanel() {
        initComponents();
    }
    
    public ExcuteEditAccountJPanel(int id){
        initComponents();
        SetGUI(id);
        jtfID.disable();
    }
    ...
    private void SetGUI(int id){
        Account Account = BLL_QLAccount.getInstance().GetAccountByID(id);
        
            jtfID.setText(String.valueOf(Account.id));
            jtfDisplayname1.setText(Account.displayname);
            jtfUsername1.setText(Account.username);
    ...
    private int GetTypeAccout(int id){
        Account Account = BLL_QLAccount.getInstance().GetAccountByID(id);
        return Account.type;
    }
    
    private String GetPasswordAccount(int id){
        Account Account = BLL_QLAccount.getInstance().GetAccountByID(id);
    ...
    private void initComponents() {
        ...
        jtfNewPassword1 = new javax.swing.JTextField();
        jtfReenterPassword2 = new javax.swing.JTextField();
        ...
        jtfNewPassword1.setBackground(new java.awt.Color(31, 36, 42));
        jtfNewPassword1.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jtfNewPassword1.setForeground(new java.awt.Color(255, 255, 255));
        jtfNewPassword1.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(169, 224, 49)));
        jtfNewPassword1.setCaretColor(new java.awt.Color(255, 255, 255));

        jtfReenterPassword2.setBackground(new java.awt.Color(31, 36, 42));
        jtfReenterPassword2.setFont(new java.awt.Font("Verdana", 0, 18)); // NOI18N
        jtfReenterPassword2.setForeground(new java.awt.Color(255, 255, 255));
        jtfReenterPassword2.setBorder(javax.swing.BorderFactory.createLineBorder(new java.awt.Color(169, 224, 49)));
        jtfReenterPassword2.setCaretColor(new java.awt.Color(255, 255, 255));

        jlbUsername7.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jlbUsername7.setForeground(new java.awt.Color(169, 224, 49));
        jlbUsername7.setText("Reenter New Password:");

        jlbUsername5.setFont(new java.awt.Font("Verdana", 0, 14)); // NOI18N
        jlbUsername5.setForeground(new java.awt.Color(169, 224, 49));
        jlbUsername5.setText("NewPassword");
                ...
                .addGroup(jpnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(jpnRootLayout.createSequentialGroup()
                        ...
                        .addGroup(jpnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                            ...
                            .addComponent(jtfNewPassword1, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE)
                            .addComponent(jtfReenterPassword2, javax.swing.GroupLayout.PREFERRED_SIZE, 260, javax.swing.GroupLayout.PREFERRED_SIZE))))
                .addGap(305, 305, 305)
        ...
        jpnRootLayout.setVerticalGroup(
            ...
            .addGroup(jpnRootLayout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(jpnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtfNewPassword1, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jlbUsername5))
                .addGap(18, 18, 18)
                .addGroup(jpnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
                    .addComponent(jtfReenterPassword2, javax.swing.GroupLayout.PREFERRED_SIZE, 39, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addComponent(jlbUsername7))
                .addGap(39, 39, 39)
                .addGroup(jpnRootLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.BASELINE)
    ...
    private void jbtOKActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jbtOKActionPerformed
        ...
        try{
            ...
            String newpassword = jtfNewPassword1.getText();
            String reenterpass = jtfReenterPassword2.getText();
            int type = GetTypeAccout(id);
            String truePassword = GetPasswordAccount(id);
            //Account a = new Account(id, username, displayname, password, type);
            
            if(!password.equals(truePassword)){
                JOptionPane.showMessageDialog(jpnRoot, "Please Enter The Correct Password");
            }
            else if(newpassword.equals("") && reenterpass.equals("")){
                BLL_QLAccount.getInstance().UpdateAccount_BLL(displayname, username, password, id);
                jpnRoot.removeAll();;
            ...
            else if(!newpassword.equals(reenterpass)){
                JOptionPane.showMessageDialog(jpnRoot, "Please Re-enter The Correct New Password");
            }
            else if(newpassword.equals(reenterpass)){
                BLL_QLAccount.getInstance().UpdateAccount_BLL(displayname, username, newpassword, id);
                jpnRoot.removeAll();;
                jpnRoot.setLayout(new BorderLayout());
                jpnRoot.add(new AccountJPanel());
                jpnRoot.validate();
    ...
    private javax.swing.JTextField jtfNewPassword1;
    private javax.swing.JTextField jtfPassword;
    private javax.swing.JTextField jtfReenterPassword2;
